...
#define NCURVES 4       // REMEMBER TO CHANGE THIS IN CHI.H AS WELL!! number of different light curves that it will calculate
...
struct Parameters {      // local bit of spot information
  ...
  double E_mono;		 // Energy set for monochromatic light curve.
...
struct Flags {
	...
	unsigned int atmosphere;      // stating which model of atmosphere we're using -- either hydrogen = 0, helium = 1.
};
