...
# This script varies emission angle from 90 degrees to 10 degrees in 10 degrees increments.
...
echo "Varying emission angle from 90 degrees in increments of 10 degrees."
...
# Writing file names
out_dir="$exe_dir/output/var/var_a_emi"
if test "$gray" -eq 0
	then out_file="${out_dir}"/"${day}"_"${emission}"_bb.txt #blackbody
else
...
while test "$emission" -gt 10 # this loop makes all of them EXCEPT FOR THE LAST ONE.
do
...
cp /Users/kitung/Desktop/thesis_material/Albert_codes/H_He_integrated/output/var/var_a_emi/"${day}"_* /Users/kitung/Desktop/thesis_material/Albert_codes/plotting_output_spectra/plot_with_variables/emi
