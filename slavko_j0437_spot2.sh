...
temp=0.0413 # 0.48 MK in keV, free para T2
...
if test "$gray" -eq 0
	then out_file="${out_dir}"/slavkoJ0437_"${day}"_bb.txt #blackbody
else
	out_file="${out_dir}"/slavkoJ0437_"${day}"_"${atmo_type}"2.txt #h or he
fi
